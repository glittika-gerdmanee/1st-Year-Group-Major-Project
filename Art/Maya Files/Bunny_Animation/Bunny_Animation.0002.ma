...
//Name: Bunny_Animation.0002.ma
//Last modified: Mon, Oct 15, 2018 09:15:46 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 72.03769075189426 17.492326894175534 16.146347477205943 ;
	setAttr ".r" -type "double3" -2.7383527296938661 84.999999999994046 4.5615965471552205e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23738277-4790-4A58-D56A-3C8D808FDE59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 77.367304145535883;
...
createNode reference -n "Bunny_Rig_0010RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Bunny_Rig_0010:COG_jnt|Bunny_Rig_0010:frontHalf_jnt" "rotate" " -type \"double3\" 0 0 -5.91334284154646195"
		...
		"translate" " -type \"double3\" 0 1.98599270606642087 4.87997411356235933"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"translateY" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"translateZ" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"rotate" " -type \"double3\" 5.91334284154646195 0 0"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"rotateX" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"visibility" " -av 1"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"translate" " -type \"double3\" 0 1.53374952435573242 2.13186201023298594"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"translateX" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"translateY" " -av"
		...
		"translateZ" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"rotate" " -type \"double3\" 17.99383178352913859 0 0"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"rotateX" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"rotateY" " -av"
...
createNode animCurveTA -n "backHalf01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -13.648100757729576 4 -13.648100757729576
		 10 -0.12700580051920668 20 17.993831783529139;
	setAttr -s 4 ".kit[1:3]"  1 18 18;
	setAttr -s 4 ".kot[1:3]"  1 18 18;
	setAttr -s 4 ".kix[1:3]"  1 0.6946758976277575 1;
	setAttr -s 4 ".kiy[1:3]"  0 0.7193228741358566 0;
	setAttr -s 4 ".kox[1:3]"  1 0.6946758976277575 1;
	setAttr -s 4 ".koy[1:3]"  0 0.7193228741358566 0;
...
createNode animCurveTA -n "backHalf02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -5.5336035289178076 4 -5.5336035289178076;
	setAttr -s 2 ".kit[1]"  1;
	setAttr -s 2 ".kot[1]"  1;
	setAttr -s 2 ".kix[1]"  1;
	setAttr -s 2 ".kiy[1]"  0;
...
createNode animCurveTA -n "frontHalf_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 18.8927069082457 10 -10.135074769779214
		 20 5.9133428415464619;
...
createNode animCurveTL -n "frontHalf_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -0.16485418943792496 10 3.2475053962329223
		 20 1.9859927060664209;
createNode animCurveTL -n "frontHalf_ctrl_translateZ";
	rename -uid "2478B0BF-43AF-5A8A-018E-56AB41CCB481";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 10 1.972744406535889 20 4.8799741135623593;
...
createNode animCurveTL -n "backHalf01_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.54567468589796775 4 0.54567468589796775
		 10 -0.43055905532655991 20 1.5337495243557324;
createNode animCurveTL -n "backHalf01_ctrl_translateZ";
	rename -uid "0C8B37A0-4031-7526-3DAE-A7A5E6C44FA3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 4 0 10 2.1318620102329859;
...
// End of Bunny_Animation.0002.ma
