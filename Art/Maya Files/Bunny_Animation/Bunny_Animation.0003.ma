...
//Name: Bunny_Animation.0003.ma
//Last modified: Mon, Oct 15, 2018 09:52:52 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 80.978242213779481 68.100340115821652 12.68347139259599 ;
	setAttr ".r" -type "double3" -33.338352729705228 83.399999999995458 2.7672120526937309e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23738277-4790-4A58-D56A-3C8D808FDE59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 103.27268617694145;
...
createNode OmnidirectionalStereo -s -n "OmnidirectionalStereo";
	rename -uid "983E8A7D-4EED-19D7-9711-0D98E7A72DA1";
lockNode -l 1 ;
createNode PxrCamera -s -n "PxrCamera";
	rename -uid "DC53B491-4276-CE44-2956-95BC193C69AB";
lockNode -l 1 ;
createNode PxrDebugShadingContext -s -n "PxrDebugShadingContext";
	rename -uid "DE83FCD9-4255-426E-3529-CEAA650480A4";
lockNode -l 1 ;
createNode PxrDefault -s -n "PxrDefault";
	rename -uid "606E9972-4704-9987-8B97-0991043FD129";
lockNode -l 1 ;
createNode PxrDirectLighting -s -n "PxrDirectLighting";
	rename -uid "541E5FA2-4194-A76C-032C-C8AC01BF3DF3";
lockNode -l 1 ;
createNode PxrOcclusion -s -n "PxrOcclusion";
	rename -uid "1BB1978A-4A51-A9C9-BA01-91AB1F676A5D";
lockNode -l 1 ;
createNode PxrPathTracer -s -n "PxrPathTracer";
	rename -uid "C056E1DC-4143-E959-0EE7-58B45B225ACC";
lockNode -l 1 ;
createNode PxrVCM -s -n "PxrVCM";
	rename -uid "8CBA5146-4EFA-E9D3-E243-4DA23DA858C4";
lockNode -l 1 ;
createNode PxrValidateBxdf -s -n "PxrValidateBxdf";
	rename -uid "4323D3A7-4489-22E2-65B4-588CD4ECFB77";
lockNode -l 1 ;
createNode PxrVisualizer -s -n "PxrVisualizer";
	rename -uid "D5E25CD6-45C9-62DD-22DB-C992DC3A47F5";
lockNode -l 1 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "53B848EA-4270-414B-789C-559F6C8B9612";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AEC53E44-4906-A112-ED94-FB9363C5A5C6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5E170099-49DD-FD99-CB89-EBA8C9DD8D11";
createNode displayLayerManager -n "layerManager";
	rename -uid "055880EE-4444-7283-66AC-5EA389918955";
createNode displayLayer -n "defaultLayer";
	rename -uid "12C98FC1-4BCE-C1CC-9B22-60860155C9C1";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CFEE0E5E-47B9-8403-3125-A2B0E58895EF";
...
createNode reference -n "Bunny_Rig_0010RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"Bunny_Rig_0010RN" 173
		2 "|Bunny_Rig_0010:COG_jnt|Bunny_Rig_0010:frontHalf_jnt" "rotate" " -type \"double3\" 0 0 -18.65990973192923263"
		...
		"translate" " -type \"double3\" 0 -0.11998609449932207 0.13663927517974273"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"translateY" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"translateZ" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"rotate" " -type \"double3\" 18.65990973192923619 0 0"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl" 
		"rotateX" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"visibility" " -av 1"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"translate" " -type \"double3\" 0 0.60040769444227549 0.1180914816164047"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"translateX" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"translateY" " -av"
		...
		"translateZ" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"rotate" " -type \"double3\" -11.89534064611465958 0 0"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"rotateX" " -av"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:backHalf01_ctrl" 
		"rotateY" " -av"
...
createNode animCurveTA -n "backHalf01_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -13.648100757729576 4 -13.648100757729576
		 10 -0.12700580051920668 23 17.993831783529139 30 -13.648100757729576;
	setAttr -s 5 ".kit[1:4]"  1 18 18 1;
	setAttr -s 5 ".kot[1:4]"  1 18 18 1;
	setAttr -s 5 ".kix[1:4]"  1 0.75370248866612566 1 1;
	setAttr -s 5 ".kiy[1:4]"  0 0.65721576257610315 0 0;
	setAttr -s 5 ".kox[1:4]"  1 0.75370248866612566 1 1;
	setAttr -s 5 ".koy[1:4]"  0 0.65721576257610304 0 0;
createNode animCurveTA -n "backHalf01_ctrl_rotateY";
	rename -uid "41D95DDC-49F0-DBDC-1CAB-DF9C48AF2A46";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 4 0 10 0 23 0 30 0;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
	setAttr -s 5 ".kiy[4]"  0;
...
createNode animCurveTA -n "backHalf02_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -5.5336035289178076 4 -5.5336035289178076
		 10 -5.5336035289178076 23 -5.5336035289178076 30 -5.5336035289178076;
	setAttr -s 5 ".kit[1:4]"  1 18 18 1;
	setAttr -s 5 ".kot[1:4]"  1 18 18 1;
...
createNode animCurveTA -n "frontHalf_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 18.8927069082457 4 11.366985732461464
		 10 -10.135074769779214 20 5.9133428415464619 30 18.8927069082457;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
	setAttr -s 5 ".kiy[4]"  0;
...
createNode animCurveTL -n "frontHalf_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -0.16485418943792496 4 0.71983162906933174
		 10 3.2475053962329223 20 1.9859927060664209 30 -0.16485418943792496;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
	setAttr -s 5 ".kiy[4]"  0;
...
createNode animCurveTL -n "frontHalf_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 4 0.34022509166696047 10 1.972744406535889
		 20 4.8799741135623593 30 0;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
	setAttr -s 5 ".kiy[4]"  0;
...
createNode animCurveTU -n "backHalf01_ctrl_visibility";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 1 4 1 10 1 23 1 30 1;
	setAttr -s 5 ".kit[0:4]"  9 9 9 9 1;
	setAttr -s 5 ".kix[4]"  1;
	setAttr -s 5 ".kiy[4]"  0;
...
createNode animCurveTL -n "backHalf01_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0.54567468589796775 4 0.54567468589796775
		 10 -0.43055905532655991 23 1.5337495243557324 30 0.54567468589796775;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
	setAttr -s 5 ".kiy[4]"  0;
...
createNode animCurveTL -n "backHalf01_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 4 0 10 2.1318620102329859 23 2.1318620102329859
		 30 0;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
...
// End of Bunny_Animation.0003.ma
