...
//Name: Bunny_Animation.0004.ma
//Last modified: Wed, Oct 17, 2018 09:25:41 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 116.37262281701214 92.038228259440928 33.968346930250206 ;
	setAttr ".r" -type "double3" -30.938352729730653 -282.59999999997558 -1.4580120204998459e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23738277-4790-4A58-D56A-3C8D808FDE59";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 139.79989032244632;
...
createNode reference -n "Bunny_Rig_0010RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -0.5283742075928296 0 0"
		2 "|Bunny_Rig_0010:MASTER_ctrl|Bunny_Rig_0010:COG_ctrl|Bunny_Rig_0010:frontHalf_ctrl|Bunny_Rig_0010:head_ctrl|Bunny_Rig_0010:ear01_L_ctrl" 
		"rotateX" " -av"
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 29 -ast 1 -aet 250 ";
	setAttr ".st" 6;
...
createNode animCurveTA -n "ear01_L_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 20 -18.870507414029831 30 0;
	setAttr -s 3 ".kit[2]"  1;
	setAttr -s 3 ".kot[2]"  1;
	setAttr -s 3 ".kix[2]"  1;
	setAttr -s 3 ".kiy[2]"  0;
...
// End of Bunny_Animation.0004.ma
