...
//Name: Dragon_Animation.0001.ma
//Last modified: Wed, Oct 31, 2018 02:35:04 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 248.98727632272835 18.704749772177671 -19.893485452942564 ;
	setAttr ".r" -type "double3" -0.93835274064819174 -990.1999999992089 2.8473864149091886e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "85052A78-4BE1-5882-9D90-8EB34857228B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 247.46930847405102;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 11.971040709840029 18.576451252466306 ;
...
createNode animCurveTA -n "backLeg_L_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -12.606368384989576 6 0 20 27.499743634874864
		 34 -12.606368384989576;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1 0.67092191197574547 1 1;
	setAttr -s 4 ".kiy[0:3]"  0 0.7415280089321038 0 0;
	setAttr -s 4 ".kox[0:3]"  1 0.67092191197574547 1 1;
	setAttr -s 4 ".koy[0:3]"  0 0.74152800893210369 0 0;
createNode animCurveTL -n "backLeg_L_ctrl_translateZ";
	rename -uid "B8786950-4D1A-CC19-5757-FC9733DB205D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 2.458196841838824 6 4.6580033075440124
		 20 -20.323988080426567 34 2.458196841838824;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
...
createNode animCurveTL -n "backLeg_L_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 2.3267912251643614 6 0 20 3.6459856134836857
		 34 2.3267912251643614;
	setAttr -s 4 ".kit[0:3]"  1 18 18 1;
	setAttr -s 4 ".kot[0:3]"  1 18 18 1;
	setAttr -s 4 ".kix[0:3]"  1 1 1 1;
	setAttr -s 4 ".kiy[0:3]"  0 0 0 0;
...
// End of Dragon_Animation.0001.ma
