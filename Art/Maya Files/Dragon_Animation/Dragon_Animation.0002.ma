...
//Name: Dragon_Animation.0002.ma
//Last modified: Wed, Oct 31, 2018 03:10:38 PM
//Codeset: 1252
file -rdi 1 -ns "Dragon_Rig_0034" -rfn "Dragon_Rig_0034RN" -op "v=0;" -typ "mayaAscii"
		 "C:/Users/s181592/Desktop/Maya Files/Dragon_Rig/Dragon_Rig.0035.ma";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 130.97798013390423 10.407120300912005 -15.116364423548452 ;
	setAttr ".r" -type "double3" -1.5383527401873118 -992.59999999916408 4.3820893608008085e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "85052A78-4BE1-5882-9D90-8EB34857228B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 130.04166937704679;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 12.949475157828488 10.215284151474069 ;
...
createNode transform -n "left";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1000.1 14.7105490162356 24.417568208529449 ;
	setAttr ".r" -type "double3" 0 -89.999999999999986 0 ;
...
createNode OmnidirectionalStereo -s -n "OmnidirectionalStereo";
	rename -uid "1D222767-410B-22A4-547C-A2801AEF128F";
lockNode -l 1 ;
createNode PxrCamera -s -n "PxrCamera";
	rename -uid "49CABDC2-492E-0BDE-7771-DABDB38C9C3A";
lockNode -l 1 ;
createNode PxrDebugShadingContext -s -n "PxrDebugShadingContext";
	rename -uid "2536962E-4E78-D539-D67C-A9A1F3705886";
lockNode -l 1 ;
createNode PxrDefault -s -n "PxrDefault";
	rename -uid "63D1188B-47F6-6180-BD9C-5A9A3CB6E750";
lockNode -l 1 ;
createNode PxrDirectLighting -s -n "PxrDirectLighting";
	rename -uid "35C63C67-4BD7-B8D0-EF5E-FEA761FAE6A3";
lockNode -l 1 ;
createNode PxrOcclusion -s -n "PxrOcclusion";
	rename -uid "6ABE1067-4213-2BE0-CBD8-F09A81C4BCD9";
lockNode -l 1 ;
createNode PxrPathTracer -s -n "PxrPathTracer";
	rename -uid "44DF2696-4F97-A4D4-A6A4-3B88B2FE330A";
lockNode -l 1 ;
createNode PxrVCM -s -n "PxrVCM";
	rename -uid "FFC81555-4B20-D782-CA9A-00973AD51499";
lockNode -l 1 ;
createNode PxrValidateBxdf -s -n "PxrValidateBxdf";
	rename -uid "79870139-45DC-0C5E-E9F9-AC89F2DA2EA0";
lockNode -l 1 ;
createNode PxrVisualizer -s -n "PxrVisualizer";
	rename -uid "4C548B57-4B2B-74B0-1EE6-57A17F811521";
lockNode -l 1 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "05E265A9-4DC8-2E83-FBEE-01871E8AFB8F";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "84C41072-4C1E-A4EB-41A5-4EA7301490A0";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "96E7EA4D-4496-08B3-7EF2-1AAB8C8D1BEC";
createNode displayLayerManager -n "layerManager";
	rename -uid "E4107CA2-4719-F8D8-D56D-888CE04E00D2";
createNode displayLayer -n "defaultLayer";
	rename -uid "F8E063B7-4AFD-F314-0A93-54ABED777DBB";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5585BC09-4885-7773-A848-18A0C77793D3";
...
createNode reference -n "Dragon_Rig_0034RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 0 15.44086663346321231"
		2 "|Dragon_Rig_0034:COG_jnt|Dragon_Rig_0034:front_jnt|Dragon_Rig_0034:frontLeg_R_jnt" 
		...
		"translate" " -type \"double3\" 0 4.65566123715113456 -6.48085169941455241"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_L_ctrl_NULL|Dragon_Rig_0034:frontLeg_L_ctrl" 
		"translateY" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_L_ctrl_NULL|Dragon_Rig_0034:frontLeg_L_ctrl" 
		"translateZ" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_L_ctrl_NULL|Dragon_Rig_0034:frontLeg_L_ctrl" 
		"rotate" " -type \"double3\" 31.9902371407076096 0 0"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_L_ctrl_NULL|Dragon_Rig_0034:frontLeg_L_ctrl" 
		"rotateX" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_R_ctrl_NULL|Dragon_Rig_0034:frontLeg_R_ctrl" 
		"visibility" " -av 1"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_R_ctrl_NULL|Dragon_Rig_0034:frontLeg_R_ctrl" 
		"translate" " -type \"double3\" 0 0 15.27368219430297103"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_R_ctrl_NULL|Dragon_Rig_0034:frontLeg_R_ctrl" 
		"translateX" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:frontLeg_R_ctrl_NULL|Dragon_Rig_0034:frontLeg_R_ctrl" 
		"translateY" " -av"
		...
		"translate" " -type \"double3\" 0 1.7975450773457311 2.84140771089735544"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:backLeg_L_ctrl_NULL|Dragon_Rig_0034:backLeg_L_ctrl" 
		"translateY" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:backLeg_L_ctrl_NULL|Dragon_Rig_0034:backLeg_L_ctrl" 
		"translateZ" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:backLeg_L_ctrl_NULL|Dragon_Rig_0034:backLeg_L_ctrl" 
		"rotate" " -type \"double3\" -10.43535564841517704 0 0"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:backLeg_L_ctrl_NULL|Dragon_Rig_0034:backLeg_L_ctrl" 
		"rotateX" " -av"
		...
		"translate" " -type \"double3\" 0 0 -20.47248447563076468"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:backLeg_R_ctrl_NULL|Dragon_Rig_0034:backLeg_R_ctrl" 
		"translateX" " -av"
		2 "|Dragon_Rig_0034:MASTER_ctrl|Dragon_Rig_0034:backLeg_R_ctrl_NULL|Dragon_Rig_0034:backLeg_R_ctrl" 
		"translateY" " -av"
...
createNode animCurveTA -n "backLeg_L_ctrl_rotateX";
	...
	setAttr ".tan" 1;
	setAttr -s 5 ".ktv[0:4]"  1 -12.606368384989576 8 0 28 0 36 27.445514745427097
		 56 -12.606368384989576;
	setAttr -s 5 ".kit[2:4]"  18 18 1;
	setAttr -s 5 ".kot[2:4]"  18 18 1;
	setAttr -s 5 ".ktl[1:4]" no yes yes yes;
	setAttr -s 5 ".kix[0:4]"  1 0.16666666666666669 0.66666666666666674 
		0.26666666666666661 1;
	setAttr -s 5 ".kiy[0:4]"  0 0.18420623813692319 0 0 0;
	setAttr -s 5 ".kox[0:4]"  0.16666666666666669 1.1262781964537383 
		0.26666666666666661 0.66666666666666674 0.16666666666666669;
	setAttr -s 5 ".koy[0:4]"  0 -0.055298040190626896 0 0 0;
createNode animCurveTL -n "backLeg_L_ctrl_translateZ";
	rename -uid "B8786950-4D1A-CC19-5757-FC9733DB205D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 2.458196841838824 8 4.3911575490017096
		 28 -12.509073825344283 36 -17.490194651467313 56 2.458196841838824;
	setAttr -s 5 ".kit[0:4]"  1 18 18 18 1;
	setAttr -s 5 ".kot[0:4]"  1 18 18 18 1;
	setAttr -s 5 ".kix[0:4]"  1 1 0.042615530979570507 1 1;
	setAttr -s 5 ".kiy[0:4]"  0 0 -0.99909154561497981 0 0;
	setAttr -s 5 ".kox[0:4]"  1 1 0.042615530979570514 1 1;
	setAttr -s 5 ".koy[0:4]"  0 0 -0.99909154561497981 0 0;
createNode animCurveTL -n "backLeg_L_ctrl_translateY";
	rename -uid "D9AFAFCB-43B0-973A-9055-8A968A4E8386";
	setAttr ".tan" 1;
	setAttr -s 5 ".ktv[0:4]"  1 2.3267912251643614 8 0 28 0 36 3.3800462748692
...
createNode animCurveTL -n "frontLeg_R_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 15.273682194302971;
...
createNode animCurveTA -n "frontLeg_L_ctrl_rotateX";
	...
	setAttr -s 5 ".kix[4]"  0.40000000000000013;
	setAttr -s 5 ".kiy[4]"  0;
	setAttr -s 5 ".kox[4]"  1;
	setAttr -s 5 ".koy[4]"  0;
...
createNode animCurveTL -n "backLeg_R_ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -20.472484475630765;
...
createNode animCurveTL -n "frontLeg_L_ctrl_translateZ";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -8.1609733100544144 20 11.741213375861442
		 44 -10.762778927872965 56 -8.1609733100544144;
	setAttr -s 4 ".kit[1:3]"  18 9 1;
	setAttr -s 4 ".kot[1:3]"  18 9 1;
	setAttr -s 4 ".ktl[0:3]" no yes yes no;
	setAttr -s 4 ".kix[0:3]"  1 1 0.060185579843811073 0.067574403007594985;
	setAttr -s 4 ".kiy[0:3]"  0 0 -0.99818720487635193 0.99771423767437895;
	setAttr -s 4 ".kox[0:3]"  0.050051108582366506 1 0.060185579843811073 
		1;
	setAttr -s 4 ".koy[0:3]"  0.99874665783154248 0 -0.99818720487635193 
		0;
select -ne :time1;
	setAttr ".o" 3;
	setAttr ".unw" 3;
...
// End of Dragon_Animation.0002.ma
