...
//Name: Dragon_Animation.0015.ma
//Last modified: Thu, Nov 01, 2018 02:50:29 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -198.90784354779308 133.58539438331849 314.8918030487938 ;
	setAttr ".r" -type "double3" -13.538353026551841 -1116.5999999997332 -9.9043517976965149e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "85052A78-4BE1-5882-9D90-8EB34857228B";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 370.32524725330541;
...
createNode animCurveTU -n "front_ctrl_visibility";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 7 1 18 1 28 1 46 1 56 1;
...
createNode animCurveTA -n "front_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 7 0 18 0 28 0 46 0 56 0;
...
createNode animCurveTA -n "front_ctrl_rotateX";
	...
	setAttr ".tan" 2;
	setAttr -s 6 ".ktv[0:5]"  1 -2.399 7 0 18 6.0000000000000009 28 0
		 46 -7 56 -2.399;
	setAttr -s 6 ".kit[2:5]"  18 1 18 2;
	setAttr -s 6 ".kot[2:5]"  18 1 18 2;
	setAttr -s 6 ".ktl[1:5]" no yes yes yes yes;
	setAttr -s 6 ".kix[3:5]"  0.33333333333333331 0.60000000000000009 
		0.33333333333333326;
...
createNode animCurveTL -n "front_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -2.515 7 -3.208 18 0 28 -3.2078663272812094
		 46 0 56 -2.515;
...
createNode animCurveTA -n "head_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr -s 6 ".ktv[0:5]"  1 0 9 3.498109875364916 19 -3.4588604227180118
		 32 1.7826646157668489 46 -4.917309032007549 56 0;
...
createNode animCurveTA -n "head_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 9 0.036484927830553189 19 -0.56352845174985156
		 32 -0.1980761530286628 46 0.52493510452574454 56 0;
	setAttr -s 6 ".kit[5]"  1;
	setAttr -s 6 ".kot[5]"  1;
	setAttr -s 6 ".kix[5]"  1;
	setAttr -s 6 ".kiy[5]"  0;
...
createNode animCurveTA -n "head_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr -s 7 ".ktv[0:6]"  1 1.7912902817933649 9 -0.59682479061980787
		 19 -5.3989092810344665 20 -5.4951596853824602 32 -2.900533008848404 46 6.0784513951613111
		 56 1.7912902817933649;
	setAttr -s 7 ".kit[0:6]"  2 2 18 18 18 18 3;
	setAttr -s 7 ".kot[0:6]"  2 2 18 18 18 18 3;
	setAttr -s 7 ".ktl[0:6]" no yes yes no yes yes no;
createNode animCurveTL -n "head_ctrl_translateZ";
	rename -uid "B7AD3445-47F3-72B5-1462-64B60D4C58E6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 9 0.01695121272103417 19 -0.23790849075953421
		 32 -0.10037812357610858 46 0.15699419183102514 56 0;
	setAttr -s 6 ".kit[3:5]"  2 18 1;
	setAttr -s 6 ".kot[3:5]"  2 18 1;
	setAttr -s 6 ".kix[5]"  1;
	setAttr -s 6 ".kiy[5]"  0;
	setAttr -s 6 ".kox[5]"  1;
	setAttr -s 6 ".koy[5]"  0;
createNode animCurveTL -n "head_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 9 -1.6242423453284367 19 1.348047520147156
		 32 -0.50915506685199419 46 1.4687911494191768 56 0;
	setAttr -s 6 ".kit[5]"  1;
	setAttr -s 6 ".kot[5]"  1;
	setAttr -s 6 ".kix[5]"  1;
	setAttr -s 6 ".kiy[5]"  0;
...
createNode animCurveTL -n "head_ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 19 -0.12884666065832012 32 -0.16346094805730352
		 46 0 56 0;
	setAttr -s 5 ".kit[4]"  1;
	setAttr -s 5 ".kot[4]"  1;
	setAttr -s 5 ".kix[4]"  1;
...
createNode animCurveTA -n "jaw_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 27.752213938884687 8 29.094872626098535
...
createNode animCurveTL -n "jaw_ctrl_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1.0795312541444413 56 1.0795312541444413;
createNode animCurveTL -n "jaw_ctrl_translateX";
	rename -uid "92E86564-436F-E541-10E7-3D97C330067A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1.9447012615393597 56 1.9447012615393597;
...
createNode animCurveTA -n "frontLeg_L_ctrl_rotateX";
	...
	setAttr -s 5 ".ktv[0:4]"  1 33.320717217816423 10 17.974435589141383
		 26 0 44 0 56 33.320717217816423;
	...
	setAttr -s 5 ".kix[1:4]"  0.27280753345694392 0.48405728683186067 
		0.59999999999999987 0.40000000000000013;
...
createNode animCurveTL -n "frontLeg_L_ctrl_translateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  1 -8.1609733100544144 10 2.6635045106542936
		 26 9.9380490903143013 44 -5.5832183656386576 56 -8.1609733100544144;
	setAttr -s 5 ".kit[0:4]"  1 18 18 9 1;
	setAttr -s 5 ".kot[0:4]"  1 18 18 9 1;
	setAttr -s 5 ".ktl[0:4]" no yes yes yes no;
	setAttr -s 5 ".kix[0:4]"  1 0.045994275327189492 1 0.055167461199686012 
		0.067574403007594985;
	setAttr -s 5 ".kiy[0:4]"  0 0.99894170332263466 0 -0.99847711602458922 
		0.99771423767437895;
	setAttr -s 5 ".kox[0:4]"  0.050051108582366506 0.045994275327189499 
		1 0.055167461199686012 1;
	setAttr -s 5 ".koy[0:4]"  0.99874665783154248 0.99894170332263466 
		0 -0.99847711602458922 0;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
// End of Dragon_Animation.0015.ma
