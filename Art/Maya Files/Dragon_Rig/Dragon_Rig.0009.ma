...
//Name: Dragon_Rig.0009.ma
//Last modified: Wed, Oct 24, 2018 09:37:24 PM
//Codeset: 1252
file -rdi 1 -ns "BabyDragon_geo_FINAL" -rfn "BabyDragon_geo_FINALRN" -op "v=0;"
		 -typ "mayaAscii" "C:/Users/Wing Him/Desktop/Art/Maya Files/Dragon_asset/BabyDragon_geo_FINAL.ma";
file -r -ns "BabyDragon_geo_FINAL" -dr 1 -rfn "BabyDragon_geo_FINALRN" -op "v=0;"
		 -typ "mayaAscii" "C:/Users/Wing Him/Desktop/Art/Maya Files/Dragon_asset/BabyDragon_geo_FINAL.ma";
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.9897436393793146 11.175775241236877 131.39133493768279 ;
	setAttr ".r" -type "double3" 352.46164726410836 -360.99999999987574 1.2425934254439705e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0D796582-4A15-559C-BEEB-8EAA672D8426";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 113.31366625440054;
...
createNode joint -n "frontAnkle_L_jnt" -p "frontKnee_L_jnt";
	...
	setAttr ".r" -type "double3" -1.14273622135235e-29 -4.7592991449512969e-22 2.7340390386347098e-14 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode camera -n "backShape" -p "back";
	...
	setAttr ".o" yes;
createNode ikHandle -n "frontLeg_L_ikh";
	rename -uid "4BD8D854-44B5-4FAA-4027-24A3ECDA8B76";
	setAttr ".t" -type "double3" 21.020240783691474 3.0000000000000302 13.999999999999986 ;
	setAttr ".roc" yes;
createNode poleVectorConstraint -n "ikHandle1_poleVectorConstraint1" -p "frontLeg_L_ikh";
	...
	setAttr ".erp" yes;
	setAttr -k on ".w0";
createNode ikHandle -n "frontLeg_R_ikh";
	rename -uid "F9733347-4F56-21B7-DA96-E49519033F46";
	setAttr ".t" -type "double3" -21.020199999999917 3.0000000000000373 13.999999999999996 ;
	setAttr ".roc" yes;
...
createNode transform -n "frontLeg_L_ctrl_NULL";
	...
	setAttr ".t" -type "double3" 20.876899719238281 0 23.328433251253891 ;
...
createNode nurbsCurve -n "frontLeg_L_ctrlShape" -p "frontLeg_L_ctrl";
	...
	setAttr -k off ".v";
	setAttr ".tw" yes;
	setAttr -s 23 ".cp[0:22]" -type "double3" -0.6126985061641359 0 -1.8148163659561565 
		-0.17943204487998929 0 -1.8984303439213512 0.32754146877393309 0 -1.7629726980883866 
		0.69453218374550385 0 -1.3656725271259811 1.166016501780109 0 -0.89588509695501273 
		1.7655217153381741 0 -0.84584454848214907 1.9552471808568681 0 -0.72863105879917389 
		1.3950764703980658 0 -0.30649216437960369 0.47549843649258161 0 -0.24281279185683236 
		1.0041442502493005 0 2.7330599566544524 0.73614815640389519 0 -4.3970300038781982 
		-0.32955315552344139 0 1.8959301202744889 -0.56030845369020721 0 -3.5042664975311366 
		-0.89142163401327856 0 1.972343002773183 -0.996401366770157 0 0.10585197178223282 
		-2.1988961381310004 0 -0.40115835130476718 -2.5716893561618921 0 -0.3689679361374974 
		-2.2812687661420377 0 -0.75007848552082068 -1.4503580120262063 0 -1.1403572626567788 
		-0.92527523187424432 0 -1.5430115240089544 0 0 0 0 0 0 0 0 0;
...
createNode OmnidirectionalStereo -s -n "OmnidirectionalStereo";
	rename -uid "4FE9B6A2-4A26-A33C-68B0-12B9E0B91159";
lockNode -l 1 ;
createNode PxrCamera -s -n "PxrCamera";
	rename -uid "4A487A9E-4951-7EC9-82C8-3BA7ECD67124";
lockNode -l 1 ;
createNode PxrDebugShadingContext -s -n "PxrDebugShadingContext";
	rename -uid "CBC71542-47DB-287C-DCD8-588C8861D831";
lockNode -l 1 ;
createNode PxrDefault -s -n "PxrDefault";
	rename -uid "7E24210B-466D-4972-05D6-0B9718CB3FE7";
lockNode -l 1 ;
createNode PxrDirectLighting -s -n "PxrDirectLighting";
	rename -uid "D779C5AE-4689-90A1-0AA2-D899706A2C40";
lockNode -l 1 ;
createNode PxrOcclusion -s -n "PxrOcclusion";
	rename -uid "7D0B2894-4D24-6EB1-9231-ED99A6FA131E";
lockNode -l 1 ;
createNode PxrPathTracer -s -n "PxrPathTracer";
	rename -uid "A25F0E69-4141-8878-A368-1FAA3AF5790F";
lockNode -l 1 ;
createNode PxrVCM -s -n "PxrVCM";
	rename -uid "50607662-44EB-2159-BE01-4BBEF33D3963";
lockNode -l 1 ;
createNode PxrValidateBxdf -s -n "PxrValidateBxdf";
	rename -uid "5E0E8BEB-4242-5FB4-86E7-D48E8A85FAD1";
lockNode -l 1 ;
createNode PxrVisualizer -s -n "PxrVisualizer";
	rename -uid "11D0E3BC-4BB9-B790-0C83-D1915F941A44";
lockNode -l 1 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1205880F-430C-94B7-F117-E6981DDC16F1";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F74AC4B0-4C8C-77CC-6276-F3BE56D835D2";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "65AF58FB-4064-2C14-73F5-5580EC622822";
createNode displayLayerManager -n "layerManager";
	rename -uid "9AC52A30-4151-4E7D-BB17-05890AF27A2E";
createNode displayLayer -n "defaultLayer";
	rename -uid "3ACACD10-4FC5-C15C-2C53-76B2BB0C8578";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9B5C5F16-4548-34CD-95D2-2289121FF11A";
...
createNode reference -n "BabyDragon_geo_FINALRN";
	rename -uid "8EDE4EDE-41C1-5C9D-1BFA-D0B4F9747EA1";
	setAttr ".fn[0]" -type "string" "C:/Users/Wing Him/Desktop/Art/Maya Files/Dragon_asset/BabyDragon_geo_FINAL.ma";
	setAttr ".ed" -type "dataReferenceEdits" 
		"BabyDragon_geo_FINALRN"
		"BabyDragon_geo_FINALRN" 0
		"BabyDragon_geo_FINALRN" 8
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Right_eye|BabyDragon_geo_FINAL:R_topEyelid" 
		"translate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Right_eye|BabyDragon_geo_FINAL:R_topEyelid" 
		"rotate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Right_eye|BabyDragon_geo_FINAL:R_bottomEyelid" 
		"translate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Right_eye|BabyDragon_geo_FINAL:R_bottomEyelid" 
		"rotate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Left_eye|BabyDragon_geo_FINAL:L_topEyelid" 
		"translate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Left_eye|BabyDragon_geo_FINAL:L_topEyelid" 
		"rotate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Left_eye|BabyDragon_geo_FINAL:L_bottomEyelid" 
		"translate" " -type \"double3\" 0 0 0"
		2 "|BabyDragon_geo_FINAL:BabyDragon_geo_grp|BabyDragon_geo_FINAL:Left_eye|BabyDragon_geo_FINAL:L_bottomEyelid" 
		"rotate" " -type \"double3\" 0 0 0";
...
createNode reference -n "sharedReferenceNode";
	rename -uid "28F815A3-4D97-3B89-739F-98BF75EEA4D3";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode makeNurbCircle -n "makeNurbCircle1";
	rename -uid "30F7A511-4AFA-0B92-DB26-7ABF0E3D0A4E";
	setAttr ".nr" -type "double3" 0 1 0 ;
createNode transformGeometry -n "transformGeometry1";
	rename -uid "D95899F9-4924-43E9-F6B1-3D8786AB99C0";
	setAttr ".txf" -type "matrix" 8.8391253618133163 0 0 0 0 8.8391253618133163 0 0
		 0 0 8.8391253618133163 0 0 0 0 1;
createNode rebuildCurve -n "rebuildCurve1";
	rename -uid "4D2426FA-4AC7-70CF-93DC-72916463CF82";
	setAttr ".s" 20;
	setAttr ".end" 1;
	setAttr ".kr" 0;
	setAttr ".kt" no;
...
connectAttr "ikHandle4_poleVectorConstraint1.w0" "ikHandle4_poleVectorConstraint1.tg[0].tw"
		;
connectAttr "rebuildCurve1.oc" "frontLeg_L_ctrlShape.cr";
...
connectAttr "sharedReferenceNode.sr" "BabyDragon_geo_FINALRN.sr";
connectAttr "makeNurbCircle1.oc" "transformGeometry1.ig";
connectAttr "transformGeometry1.og" "rebuildCurve1.ic";
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "ikRPsolver.msg" ":ikSystem.sol" -na;
// End of Dragon_Rig.0009.ma
