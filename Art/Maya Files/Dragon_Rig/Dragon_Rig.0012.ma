...
//Name: Dragon_Rig.0012.ma
//Last modified: Thu, Oct 25, 2018 12:00:32 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 118.16828418689073 57.205131504230636 153.41816943205279 ;
	setAttr ".r" -type "double3" 344.06164722822172 -1046.1999999998211 1.9137269101115913e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0D796582-4A15-559C-BEEB-8EAA672D8426";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 210.84305095508978;
...
createNode joint -n "backFoot_R_jnt" -p "backAnkle_R_jnt";
	...
	setAttr ".r" -type "double3" 1.4033418597069752e-14 2.5661546137573641e-30 -2.9327481300084152e-30 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
