...
public class FreezeAttackController : MonoBehaviour
{
    // how long to freeze an entity for
    ...
    private void OnTriggerEnter(Collider col)
    {
        ...
        // is the hit object the freeze attacks owner
